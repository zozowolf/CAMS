...
namespace ModelisationBD {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string Car) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Car {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'Car\' dans la table \'Table\' est DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsCarNull() {
                return this.IsNull(this.tableTable.CarColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetCarNull() {
                this[this.tableTable.CarColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace ModelisationBD.DatabaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Car = 1 AND " +
                "[Car] IS NULL) OR ([Car] = @Original_Car)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Car]) VALUES (@Car);\r\nSELECT Id, Car FROM [Table] WHE" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Car] = @Car WHERE (([Id] = @Original_Id) AND ((@IsNull_" +
                "Car = 1 AND [Car] IS NULL) OR ([Car] = @Original_Car)));\r\nSELECT Id, Car FROM [T" +
                "able] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ModelisationBD.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Car FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Car) {
        ...
        public virtual int Insert(string Car) {
            if ((Car == null)) {
        ...
        public virtual int Update(string Car, int Original_Id, string Original_Car, int Id) {
            if ((Car == null)) {
            ...
            if ((Original_Car == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_Car));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Car, int Original_Id, string Original_Car) {
            return this.Update(Car, Original_Id, Original_Car, Original_Id);
        }
    }
